import require$$1, { resolve, join, normalize as normalize$3, dirname } from 'path';
...
import { once as once$1 } from 'events';
...
var manifest = {
	...
	{
		type: "script",
		href: "/assets/index.0cae4d8d.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.b924645a.js"
	},
	{
		type: "style",
		href: "/assets/entry-client.7692dda2.css"
	},
	{
		type: "script",
		href: "/assets/divider.b01963e9.js"
	},
	{
		type: "style",
		href: "/assets/index.34b589db.css"
	}
],
	"/*404": [
	{
		type: "script",
		href: "/assets/_...404_.b024e91f.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.b924645a.js"
	...
	{
		type: "script",
		href: "/assets/HttpStatusCode.f2416318.js"
	},
	{
		type: "script",
		href: "/assets/divider.b01963e9.js"
	...
	{
		type: "script",
		href: "/assets/_..400_.206de7b6.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.b924645a.js"
	...
	{
		type: "script",
		href: "/assets/_..401_.31d237d3.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.b924645a.js"
	...
	{
		type: "script",
		href: "/assets/_..402_.8ff12ce4.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.b924645a.js"
	...
	{
		type: "script",
		href: "/assets/_..403_.01fdeff5.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.b924645a.js"
	...
	{
		type: "script",
		href: "/assets/_..425_.30b247e0.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.b924645a.js"
...
function normalize$2(path, omitSlash = false) {
...
function resolvePath(base, path, from) {
    ...
    const basePath = normalize$2(base);
    const fromPath = from && normalize$2(from);
    let result = "";
    ...
    return (result || "/") + normalize$2(path, !result);
}
...
function joinPaths(from, to) {
    return normalize$2(from).replace(/\/*(\*.*)?$/g, "") + normalize$2(to);
}
...
const stitches = X({ prefix: "hope" });
const { css, globalCss, getCssText, keyframes } = stitches;
...
const PSEUDO_SELECTORS_MAP = new Map([
...
function createThemeVars(scales, cssVarPrefix) {
    ...
    const vars = unflatten(varsReference, FLATTEN_SEPARATOR);
    const cssVarsValues = {
        root: rootVars,
        dark: darkVars,
    };
 ...
 * <img width="100px"/>
 */
const prefixedHTMLPropsMap = new Map([
    ["htmlWidth", "width"],
    ["htmlHeight", "height"],
    ["htmlSize", "size"],
]);
...
function styled(component, styleInterpolation, staticClassName) {
  ...
  const hopeComponent = createHopeComponent(props => {
    ...
    runOnce(theme);
    const [local, prefixedHTMLProps, variantProps, styleProps, others] = splitProps(props,
    ...
    return createComponent(Dynamic, mergeProps({
      ...
      get ["class"]() {
        return clsx(staticClassName, styleResult?.baseClassName, ...variantClassNames(), sxClassName(), local.class) || undefined;
      }
...
const _tmpl$$d = ["<script", " id=\"hope-ui-color-mode-script\"", ">", "</script>"];
...
const Icon = createHopeComponent(props => {
  ...
  return createComponent(Show, {
    ...
    get fallback() {
      return createComponent(BaseIcon, mergeProps({
        get viewBox() {
...
function createIcon(options) {
  ...
  return createHopeComponent(props => createComponent(Icon, mergeProps({
    viewBox: viewBox
  }, defaultProps, props, {
    get children() {
      return options.path;
...
const _tmpl$$b = ["<g", " fill=\"none\"><path d=\"M12 19a7 7 0 1 0 0-14a7 7 0 0 0 0 14zm0 3c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10z\" opacity=\"0.2\" fill=\"currentColor\" fill-rule=\"evenodd\" clip-rule=\"evenodd\"></path><path d=\"M2 12C2 6.477 6.477 2 12 2v3a7 7 0 0 0-7 7H2z\" fill=\"currentColor\"></path></g>"];
const SpinnerIcon = createIcon({
  path: () => ssr(_tmpl$$b, ssrHydrationKey())
});
...
function hideOthers(document, modal) {
    ...
    const elements = Array.from(document.querySelectorAll(ROOT_ELEMENTS_SELECTOR))
 ...
 */
function watchModals(selector = "body", { document = currentDocument } = {}) {
    /**
...
const useButtonStyleConfig = createStyleConfig(({ vars }) => ({
    root: {
        baseStyle: {
            appearance: "none",
            position: "relative",
          ...
          return [createComponent(Show, {
            ...
            get children() {
              return createComponent(Show, {
                ...
                get fallback() {
                  return ssr(_tmpl$$a, ssrHydrationKey(), "opacity:" + 0, escape$1(createComponent(ButtonContent, contentProps)));
                },
                get children() {
                  return local.loadingText;
                }
...
function ButtonContent(props) {
  ...
  }), props.children, createComponent(Show, {
    get when() {
...
const Divider = createHopeComponent(props => {
  ...
  return createComponent(hope.hr, mergeProps({
    get as() {
...
function getAssetsFromManifest(manifest, routerContext) {
  ...
  const links = match.reduce((r, src) => {
    r[src.href] = src.type === "style" ? ssr(_tmpl$$8, ssrHydrationKey(), ssrAttribute("href", escape$1(src.href, true), false)) : src.type === "script" ? ssr(_tmpl$2, ssrHydrationKey(), ssrAttribute("href", escape$1(src.href, true), false)) : undefined;
    return r;
  }, {});
...
const _tmpl$$7 = ["<main", "><!--#-->", "<!--/--><section class=\"intro\"><h1 class=\"title\">NELMIN</h1><!--#-->", "<!--/--><h2 class=\"subtitle\">Your development Team <br>for <span class=\"typedtext-whitespace\" id=\"typedText\"></span></h2></section><section class=\"texting\"><h1 class=\"title\">Chat with our <span style=\"color: #5f3dc4;text-decoration: underline;\">Community</span>!</h1><iframe class=\"discord-iframe\" src=\"https://discord.com/widget?id=1025755227506352128&amp;theme=dark\" sandbox=\"allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts\"></iframe></section><section class=\"projects\"><h1 class=\"title\">Our <span style=\"color: #5f3dc4;text-decoration: underline;\">Projects</span>!</h1><div class=\"card-wrapper\"><div class=\"card\"><div class=\"card-img\"><img src=\"src/assets/img/jar-file.png\" alt=\"test\"></div><div class=\"card-title\">Learn Coding Spigot Plugins</div><div class=\"card-content\">- In this Video Course you will learn how you can create your own Spigot Plugin with Java. The Creator <a href=\"https://discord.com/users/504014438383222804/\" style=\"color: #5f3dc4;text-decoration: none;\">!PrayForMyCode#7716</a> try's to do it beginner friendly as possible.</div><div class=\"card-additional-details\">Type: Video Course <br>Price: 10\u20AC <br>Creator: <a href=\"https://discord.com/users/504014438383222804/\" style=\"color: #5f3dc4;text-decoration: none;\">!PrayForMyCode#7716</a><br><a href=\"#\" target=\"_blank\" style=\"text-decoration:none;\">", "</a></div></div></div></section></main>"];

// const subtitleTyper = new TypeText({ loop: true });
// subtitleTyper.typeString("Minecraft Plugins").pause(1500).deleteAll().typeString("Websites").pause(1500).deleteAll().typeString("Discord Bots").pause(1500).deleteAll().typeString("Coding Support").pause(1500).deleteAll().start();

function Home() {
  return ssr(_tmpl$$7, ssrHydrationKey(), escape$1(createComponent(Title, {
    children: "NELMIN DEVS"
  })), escape$1(createComponent(Divider, {
    variant: "solid",
    "class": "hr"
  })), escape$1(createComponent(Button, {
    variant: "soft",
    colorScheme: "success",
...
const _tmpl$$6 = ["<main", "><!--#-->", "<!--/--><section class=\"intro\"><h1 class=\"title\">NELMIN</h1><!--#-->", "<!--/--><h2 class=\"subtitle\">The Requested URL doesn't exists<br><!--#-->", "<!--/--></h2></section></main>"];
const navigate$5 = useNavigate();
function NotFound$5() {
  createComponent(HttpStatusCode, {
    code: 404
  });
  return ssr(_tmpl$$6, ssrHydrationKey(), escape$1(createComponent(Title, {
    children: "404 - NELMIN DEVS"
  })), escape$1(createComponent(Divider, {
    variant: "solid",
    "class": "hr"
  })), escape$1(createComponent(Button, {
...
const _tmpl$$5 = ["<main", "><!--#-->", "<!--/--><section class=\"intro\"><h1 class=\"title\">NELMIN</h1><!--#-->", "<!--/--><h2 class=\"subtitle\">The request message was constructed incorrectly.<br><!--#-->", "<!--/--></h2></section></main>"];
const navigate$4 = useNavigate();
function NotFound$4() {
  createComponent(HttpStatusCode, {
    code: 400
  });
  return ssr(_tmpl$$5, ssrHydrationKey(), escape$1(createComponent(Title, {
    children: "400 - NELMIN DEVS"
  })), escape$1(createComponent(Divider, {
    variant: "solid",
    "class": "hr"
  })), escape$1(createComponent(Button, {
...
const _tmpl$$4 = ["<main", "><!--#-->", "<!--/--><section class=\"intro\"><h1 class=\"title\">NELMIN</h1><!--#-->", "<!--/--><h2 class=\"subtitle\">The request cannot be performed without valid authentication.<br><!--#-->", "<!--/--></h2></section></main>"];
const navigate$3 = useNavigate();
function NotFound$3() {
  createComponent(HttpStatusCode, {
    code: 401
  });
  return ssr(_tmpl$$4, ssrHydrationKey(), escape$1(createComponent(Title, {
    children: "401 - NELMIN DEVS"
  })), escape$1(createComponent(Divider, {
    variant: "solid",
    "class": "hr"
  })), escape$1(createComponent(Button, {
...
const _tmpl$$3 = ["<main", "><!--#-->", "<!--/--><section class=\"intro\"><h1 class=\"title\">NELMIN</h1><!--#-->", "<!--/--><h2 class=\"subtitle\">A Payment is required.<br><!--#-->", "<!--/--></h2></section></main>"];
const navigate$2 = useNavigate();
function NotFound$2() {
  createComponent(HttpStatusCode, {
    code: 402
  });
  return ssr(_tmpl$$3, ssrHydrationKey(), escape$1(createComponent(Title, {
    children: "402 - NELMIN DEVS"
  })), escape$1(createComponent(Divider, {
    variant: "solid",
    "class": "hr"
  })), escape$1(createComponent(Button, {
...
const _tmpl$$2 = ["<main", "><!--#-->", "<!--/--><section class=\"intro\"><h1 class=\"title\">NELMIN</h1><!--#-->", "<!--/--><h2 class=\"subtitle\">The request was not executed due to lack of authorization of the client<br><!--#-->", "<!--/--></h2></section></main>"];
...
const _tmpl$$1 = ["<main", "><!--#-->", "<!--/--><section class=\"intro\"><h1 class=\"title\">NELMIN</h1><!--#-->", "<!--/--><h2 class=\"subtitle\">The server asks the client to resend the request because the TLS connection has not been fully established.<br><!--#-->", "<!--/--></h2></section></main>"];
const navigate = useNavigate();
function NotFound() {
  createComponent(HttpStatusCode, {
    code: 403
  });
  return ssr(_tmpl$$1, ssrHydrationKey(), escape$1(createComponent(Title, {
    children: "403 - NELMIN DEVS"
  })), escape$1(createComponent(Divider, {
    variant: "solid",
    "class": "hr"
...
const fileRoutes = [{
  ...
  component: NotFound$5,
  path: "/*404"
}, {
  component: NotFound$4,
  path: "/:..400"
}, {
  component: NotFound$3,
  path: "/:..401"
}, {
  component: NotFound$2,
  path: "/:..402"
}, {
  component: NotFound$1,
  path: "/:..403"
}, {
  component: NotFound,
  path: "/:..425"
...
const _tmpl$ = ["<footer", " style=\"text-align:center;width:100%;height:8rem;padding-top:1rem;\">Maximilian Guthmann <br>Obenitterstra\xDFe 60 <br>42719 Solingen, Germany <br>E-Mail Soon!</footer>"];
function Root() {
  injectCriticalStyle();
  return createComponent(Html, {
    ...
    get children() {
      return [createComponent(Head, {
        ...
        get children() {
          return [createComponent(ColorModeScript, {}), createComponent(HopeProvider, {
            get children() {
          ...
          }), createComponent(Scripts, {}), ssr(_tmpl$, ssrHydrationKey())];
        }
      })];
    }
  });
...
const entryServer = createHandler(renderAsync(event => createComponent(Router, {
  get children() {
